...
!function(t, e) {
    ...
    var L = "carousel"
      ...
      , Q = "active"
      , V = "slide"
      , Y = "carousel-item2-right"
      , z = "carousel-item2-left"
      , X = "carousel-item2-next"
      , G = "carousel-item2-prev"
      , $ = "pointer-event"
      , J = ".active"
      , Z = ".active.carousel-item2"
      , tt = ".carousel-item2"
      , et = ".carousel-item2 img"
      , nt = ".carousel-item2-next, .carousel-item2-prev"
      , it = ".carousel-indicators"
      , ot = "[data-slide], [data-slide-to]"
      , rt = '[data-ride="carousel2"]'
      , st = {
        TOUCH: "touch",
        PEN: "pen"
    }
      ...
      , Q = "active"
      , V = "slide"
      , Y = "carousel-item3-right"
      , z = "carousel-item3-left"
      , X = "carousel-item3-next"
      , G = "carousel-item3-prev"
      , $ = "pointer-event"
      , J = ".active"
      , Z = ".active.carousel-item3"
      , tt = ".carousel-item3"
      , et = ".carousel-item3 img"
      , nt = ".carousel-item3-next, .carousel-item3-prev"
      , it = ".carousel-indicators"
      , ot = "[data-slide], [data-slide-to]"
      , rt = '[data-ride="carousel3"]'
      , st = {
        TOUCH: "touch",
        PEN: "pen"
    }
